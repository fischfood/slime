...
<section id="comments">
	<div class="notice">
		<p class="bottom"><?php esc_html_e( 'This post is password protected. Enter the password to view comments.', 'slime' ); ?></p>
	</div>
</section>
...
<div id="comments" class="comments-area">
	...
	?>
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'slime' ); ?></p>
	<?php endif; ?>
